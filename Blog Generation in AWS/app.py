import boto3 # used to invoke foundational model
...
def blog_generate_using_bedrock(blogtopic:str)-> str:
    ...
    except Exception as err:   #loggged in cloudwatch 
...
def lambda_handler(event, context):       # blogtopic will be captured in event
    # TODO implement
